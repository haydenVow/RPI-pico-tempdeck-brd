...
MakeBoard("tempdeck32u4cat", "Microchip Technology Inc", "Opentrons TempDeck", "0x04D8", "0xEE93", "AVR_TEMPDECK", 2, "boot2_w25q080_2_padded_checksum")
#MakeBoard(name, vendor_name, product_name, vid, pid, boarddefine, flashsizemb, boot2):